package com.behaviourpassingexamplebyJava7.test;
...
public class BehaviourPassingExampleByJava7Test {
	...
	public void test_04_BehaviourPassingExampleByJava7Case1PrintWhoseAnyNameStartsWithC()
	{
		...
		BehaviourPassingExampleByJava7 behaviourPassingExampleByJava7 = new BehaviourPassingExampleByJava7();
		behaviourPassingExampleByJava7.printWithCondition(peoples , new ConditionForPrint() {
	...
	public void test_05_BehaviourPassingExampleByJava7Case2PrintSort()
	{
		...
		BehaviourPassingExampleByJava7 behaviourPassingExampleByJava7 = new BehaviourPassingExampleByJava7();
		List<Person> peoplesSorted = behaviourPassingExampleByJava7.printSorted(peoples, new Comparator<Person>() {
		...
		List<Person> peoplesSorted1 = behaviourPassingExampleByJava7.printSorted(peoples, new Comparator<Person>() {

			@Override
			public int compare(Person p1, Person p2) {
				/*char c1= p1.getFirstName().charAt(0);
				char c2= p2.getFirstName().charAt(0);
				if((int)c1<(int)c2)
				{
					return -1;
				}
